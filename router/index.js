...
router.post(
	'/journal/delnode',
	roleMiddleware(['ADMIN']),
	journalController.delNode
)
router.post(
	'/journal/addnode',
	roleMiddleware(['ADMIN']),
	journalController.addNode
)
router.post(
	'/journal/editnode',
	roleMiddleware(['ADMIN']),
	journalController.editNode
)
router.get('/journal/areas', authMiddleware, journalController.getAllAreas)
router.post(
	'/journal/delarea',
	roleMiddleware(['ADMIN']),
	journalController.delArea
)
router.post(
	'/journal/addarea',
	roleMiddleware(['ADMIN']),
	journalController.addArea
)
router.post(
	'/journal/editarea',
	roleMiddleware(['ADMIN']),
	journalController.editArea
)
router.get(
	'/journal/records',
	roleMiddleware(['USER']),
	journalController.getAllJournalItems
)
router.post(
	'/journal/addrecord',
	roleMiddleware(['USER']),
	journalController.addJournalItem
)
